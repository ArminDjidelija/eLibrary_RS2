...
{
    public class VrsteSadrzajaValidator : BaseValidatorService<Database.VrsteSadrzaja>, IVrsteSadrzajaValidator
    {
        private readonly ELibraryContext context;

        public VrsteSadrzajaValidator(ELibraryContext context) : base(context)
        {
