...
{
    public class KreiranaRezervacijaState : BaseRezervacijeState
    {

        public KreiranaRezervacijaState(ELibraryContext context, IMapper mapper, IServiceProvider service) 
